...
const teachStay = new Dog("Fido", "stay");
...
dogIntro.apply([this.name, this.breed]);
/*
...
//CODE HERE
const fidoIntro = new Dog("Fido", "chicken", "tennis ball");
...
Phone.prototype.sell = function () {
  return this.sold === true && `${this.brand} has been sold.`;
};
